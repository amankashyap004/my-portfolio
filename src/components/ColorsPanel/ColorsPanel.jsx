...
export default function ColorsPanel() {
   ...
   return (
      <section className="flex justify-center items-center">
         <div
            className={`cursor-pointer mr-2 flex justify-center items-center
            ${isColorsPanel ? "m-0" : "mx-2 my-6 sm:my-3"}`}
         ...
         <div
            className={`bg-gray-600 p-4 flex justify-center items-center rounded-bl-md 
            ${isColorsPanel ? "block" : "hidden"}`}
         >
            <div
