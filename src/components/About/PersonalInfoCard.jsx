...
export default function PersonalInfoCard({ title, name, icon }) {
   return (
      <section className="flex justify-between items-start px-4 py-3 cursor-pointer bg-blue-800 rounded-lg hover:bg-blue-700 transition-all duration-500 ease-in-out md:px-2 sm:w-full">
