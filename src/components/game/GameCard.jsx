   ...
   return (
      <Link to={link ? link : "/"}>
         <section className="ease-in-out delay-150 rounded-lg w-[330px] m-4 cursor-pointer relative sm:mx-0 sm:my-2 sm:px-2 sm:w-full">
            ...
            <h3 className="absolute top-0 text-gray-900 dark:text-gray-100 text-base uppercase pt-2 pl-2 font-black z-10 sm:text-sm">
               {heading}
            </h3>
            <p className="absolute bottom-0 text-gray-900 dark:text-gray-100 text-sm font-extrabold p-2 z-10">
               {description}&nbsp;...
            </p>
         </section>
      </Link>
